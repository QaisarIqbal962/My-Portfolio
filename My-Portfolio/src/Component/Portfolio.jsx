...
const Portfolio = () => {
  const portfolios = [
...

    {
      ...
      src: Search,
      lang: "JavaScript",
      live: "https://image-search-app-six-gamma.vercel.app/",
      code: "https://github.com/QaisarIqbal962/Image-Search-App"
    },

    {
      ...
      src: jobPortal,
      lang: "JavaScript",
      live: "https://job-portal-website-three.vercel.app/",
      code: "https://github.com/QaisarIqbal962/Job_Portal_Website.git",
    },
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0">
          {portfolios.map(({ id, src, lang, live, code }) => (
            <div key={id} className="shadow-md shadow-gray-600 rounded-lg">
              ...
              />
              <h1 className="text-center py-2 font-semibold text-lg text-blue-400 shadow-md">
                {lang}
              </h1>
